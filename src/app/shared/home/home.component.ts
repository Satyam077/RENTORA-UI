  ...
  features = [
    {
      ...
      description:
        'Manage all your properties in one centralized platform with ease',
    },
    {
      icon: 'tenant',
    ...
    },
    {
      ...
      description:
        'Monitor rent payments, generate invoices, and track financial records',
    },
    {
      icon: 'maintenance',
      title: 'Maintenance Requests',
      description:
        'Handle maintenance tickets and service requests efficiently',
    },
    {
      icon: 'agreement',
